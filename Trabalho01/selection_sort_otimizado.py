...
def selection_sort_otimizado(arr):
...
def main():
    ...
    tempo_aleatoria = selection_sort_otimizado(lista_aleatoria[:])
    print("Aleatória:", tempo_aleatoria)

    tempo_ordenada = selection_sort_otimizado(lista_ordenada[:])
    print("Ordenada:", tempo_ordenada)

    tempo_inversa = selection_sort_otimizado(lista_inversa[:])
