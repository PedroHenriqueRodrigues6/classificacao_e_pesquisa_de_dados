...
def bubble_sort_nao_otimizado(arr):
...
def main():
    ...
    tempo_aleatoria = bubble_sort_nao_otimizado(lista_aleatoria[:])
    print("Aleatória:", tempo_aleatoria)

    tempo_ordenada = bubble_sort_nao_otimizado(lista_ordenada[:])
    print("Ordenada:", tempo_ordenada)

    tempo_inversa = bubble_sort_nao_otimizado(lista_inversa[:])
