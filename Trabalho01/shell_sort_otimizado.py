...
def main():
    ...
    tempo_aleatoria = shell_sort_otimizado(lista_aleatoria[:])
    print("Aleatória:", tempo_aleatoria)

    tempo_ordenada = shell_sort_otimizado(lista_ordenada[:])
    print("Ordenada:", tempo_ordenada)

    tempo_inversa = shell_sort_otimizado(lista_inversa[:])
