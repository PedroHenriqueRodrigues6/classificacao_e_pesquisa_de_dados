...
def main():
    ...
    tempo_aleatoria = heap_sort_otimizado(lista_aleatoria[:])
    print("Aleatória:", tempo_aleatoria)

    tempo_ordenada = heap_sort_otimizado(lista_ordenada[:])
    print("Ordenada:", tempo_ordenada)

    tempo_inversa = heap_sort_otimizado(lista_inversa[:])
